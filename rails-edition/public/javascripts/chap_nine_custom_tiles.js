...
BlueMarbleTiles.getTileUrl = function(tile,zoom){
	if(zoom > 5) return 'http://googlemapsbook.com/chapter9/EquidistantCylindricalProjection/tiles/no_tiles_at_zoom_level.png';
	else return 'http://googlemapsbook.com/chapter9/EquidistantCylindricalProjection/tiles/land_ocean_ice/tile.' + zoom + '.' +
...
BlueMarbleNightTiles.getTileUrl = function(tile,zoom){
	if(zoom > 3) return 'http://googlemapsbook.com/chapter9/EquidistantCylindricalProjection/tiles/no_tiles_at_zoom_level.png';
	else return 'http://googlemapsbook.com/chapter9/EquidistantCylindricalProjection/tiles/land_ocean_ice_lights/tile.' + zoom + '.' +
	(tile.x + tile.y * Math.pow(2,zoom)) + '.png';
};
...
BlueMarbleCloudyTiles.getTileUrl = function(tile,zoom){
	if(zoom > 5) return 'http://googlemapsbook.com/chapter9/EquidistantCylindricalProjection/tiles/no_tiles_at_zoom_level.png';
	else return 'http://googlemapsbook.com/chapter9/EquidistantCylindricalProjection/tiles/land_ocean_ice_cloud/tile.' + zoom + '.' +
	(tile.x + tile.y * Math.pow(2,zoom)) + '.png';
};
